...
// the open-source flow's +incdir only (see verification/uvm/vlt/Makefile) -- a
// VCS/Xcelium flow uses the real header from UVM_HOME and never sees this file.
//
// (First comment word avoids the tool name, which is parsed as a pragma.)
